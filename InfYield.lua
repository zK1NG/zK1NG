...
CMDs[#CMDs + 1] = {NAME = 'pushaura / apush', DESC = 'MalwareHub'}
CMDs[#CMDs + 1] = {NAME = 'removetorso / rtorso', DESC = 'MalwareHub'}
...
addcmd('pushaura', {'apush'}, function(args, speaker)
while wait(0.1) do
	...
	for _,v in pairs(game.Players:GetDescendants()) do
		if v:IsA("Player") then
			if v.Name ~= game.Players.LocalPlayer.Name then
				local args = {[1] = game:GetService("Players")[v.Name].Character}
...
addcmd('removetorso', {'rtorso'}, function(args, speaker)
game.Players.LocalPlayer.Character.UpperTorso.WaistRigAttachment:Destroy()
...
game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(Vector3.new(randomPlayer.Character.LowerTorso.Position.X, randomPlayer.Character.LowerTorso.Position.Y, randomPlayer.Character.LowerTorso.Position.Z))
end
end)
